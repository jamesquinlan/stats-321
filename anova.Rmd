...
Weight loss is a continuous quantitative dependent variable and diet is the independent categorical variable with at least levels.  
...
```
Although the p-value of Group 1 is near $0.05$, each test resulted in a p-value $> 0.05$, therefore, we fail to reject the null hypothesis of no outliers.  
